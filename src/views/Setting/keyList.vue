<template>
  <div>
    ...
    <el-table ref="multipleTable" :data="keyData.slice((page-1)*limit,page*limit)" tooltip-effect="dark" style="width: 100%"
...
export default {
  ...
  methods: {
    getList () {
      ...
      //   page: this.page
      // })
      this.$axios({ method: 'get', url: '/api/secret', params: this.keyForm }).then(res => {
