<template>
  <div>
    <router-link to="/roleUpload"><el-button style="margin-bottom: 20px;">创建角色</el-button></router-link>
    <el-table ref="multipleTable" :data="userData.slice((page-1)*limit,page*limit)" tooltip-effect="dark" style="width: 100%"
      ...
      <el-table-column prop="name" label="角色名称" width="370"></el-table-column>
...
export default {
  ...
  methods: {
    getList () {
      ...
      //   page: this.page
      // })
      this.$axios({ method: 'get', url: '/api/role', params: "" }).then(res => {
